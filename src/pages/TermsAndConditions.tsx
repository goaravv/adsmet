      ...
      <main className="pt-16 md:pt-20">
        <article className="container mx-auto px-4 py-12 md:py-16 text-foreground">
          ...
          >
            ...
            <h2 className="text-2xl font-heading font-semibold text-accent">1. Services</h2>
            <p className="font-medium">
            ...
            <h2 className="text-2xl font-heading font-semibold text-accent">2. User Responsibilities</h2>
            <p className="font-medium">
            ...
            <h2 className="text-2xl font-heading font-semibold text-accent">3. Payment and Billing</h2>
            <p className="font-medium">
            ...
            <h2 className="text-2xl font-heading font-semibold text-accent">4. Limitation of Liability</h2>
            <p className="font-medium">
            ...
            <h2 className="text-2xl font-heading font-semibold text-accent">5. Changes to Terms</h2>
            <p className="font-medium">
